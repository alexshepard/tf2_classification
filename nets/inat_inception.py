...
def compiled_model(img_shape, num_classes):
    ...
    # currently identical to the first classification head
    # but this will shortly be "factorized"/"compressed"
    x = tf.keras.layers.GlobalAveragePooling2D(name='pool2')(base_model.output)
    ...
    # build a dual-output/dual-head model
